...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/10 21:47:59 by vkaidans          #+#    #+#             */
/*   Updated: 2019/02/10 21:48:00 by vkaidans         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sha384_transform(ULINT *buff, const ULINT *data)
{
	ULINT	t[6];
	int		i;
...
void		sha384_create_hash(t_sha *sh)
{
	UINT	i;
	ULINT	data[80];
	ULINT	buff[8];
