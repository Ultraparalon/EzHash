...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/07 13:31:52 by vkaidans          #+#    #+#             */
/*   Updated: 2019/02/07 13:31:53 by vkaidans         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sha256_transform(UINT *buff, const UINT *data)
{
	UINT	t[6];
	int		i;
...
void		sha256_create_hash(t_sha *sh)
{
	UINT i;
	UINT data[64];
	UINT buff[8];
